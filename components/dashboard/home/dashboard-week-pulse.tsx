...
export function DashboardWeekPulse({
  ...
  if (chips.length === 0 && !canAccessActivities) {
    return null;
  }
  ...
  return (
    ...
    >
      {canAccessActivities ? (
        <div className="rounded-xl border border-domain-activities/20 bg-gradient-to-br from-domain-activities-subtle via-card to-card p-4 sm:p-5">
