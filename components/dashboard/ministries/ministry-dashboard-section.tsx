...
export function MinistryDashboardSection({
  ...
  const canAddMembers = permissions
    ...
    <>
      <div className="space-y-6">
        ...
        <Link
          ...
          className="flex w-full items-start gap-4 rounded-lg border border-border bg-card px-5 py-4 text-left transition-colors hover:bg-muted/40"
        >
